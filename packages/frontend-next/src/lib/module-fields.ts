...
export const fieldConfigs: Record<string, ModuleField[]> = {
  ...
  leads: [
    ...
    { name: 'rating', type: 'select' },
    { name: 'interest', type: 'select' },
    { name: 'leadScore', type: 'number' },
    { name: 'nextFollowUp', type: 'datetime-local' },
    { name: 'description', type: 'textarea' },
  ...
  projects: [
    ...
    { name: 'budgetType', type: 'select' },
    { name: 'billingRate', type: 'number' },
    { name: 'healthStatus', type: 'select' },
    { name: 'department', type: 'text' },
    { name: 'url', type: 'text' },
    { name: 'description', type: 'textarea' },
  ],
  ...
  projecttasks: [
    ...
    { name: 'milestoneId', type: 'milestone-select' },
  ...
  timeentries: [
    { name: 'projectId', type: 'project-select', required: true },
    { name: 'taskId', type: 'task-select' },
    { name: 'userId', type: 'user-select', required: true },
  ...
  projectresources: [
    ...
    { name: 'userId', type: 'user-select', required: true },
    { name: 'role', type: 'text' },
    { name: 'allocationPercent', type: 'number' },
  ...
  payments: [
    { name: 'purchaseOrderId', type: 'purchaseorder-select', required: true },
    { name: 'amount', type: 'number', required: true },
    { name: 'paymentDate', type: 'date' },
    { name: 'method', type: 'select' },
    { name: 'reference', type: 'text' },
