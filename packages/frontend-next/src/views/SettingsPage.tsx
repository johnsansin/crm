...
import { AccessSettings } from '@/views/settings/AccessSettings'
import { PicklistSettings } from '@/views/settings/PicklistSettings'
import { LeadSettings } from '@/views/settings/LeadSettings'
import { PotentialSettings } from '@/views/settings/PotentialSettings'
import { EmailSettings } from '@/views/settings/EmailSettings'
import { AuditSettings } from '@/views/settings/AuditSettings'
import { AutomationSettings } from '@/views/settings/AutomationSettings'
