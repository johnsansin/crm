                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="border-b bg-muted/50">
                      ...
                      {['view', 'create', 'edit', 'delete', 'import', 'export'].map(a => <th key={a} className="text-center px-2 py-2.5 font-semibold text-muted-foreground uppercase tracking-wider">{a}</th>)}
                    </tr>
                  </thead>
                  <tbody>
                    {MODULES.map((m, i) => {
