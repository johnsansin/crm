        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {plans.map(plan => (
              <div
                key={plan.name}
                className={`relative p-7 rounded-2xl border bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl shadow-lg flex flex-col ${
                  plan.highlight
                    ? 'border-sky-400 dark:border-sky-500 shadow-sky-200/60 dark:shadow-indigo-950/60'
                    : 'border-white/70 dark:border-white/10 shadow-sky-200/40 dark:shadow-indigo-950/40'
                }`}
              >
                {plan.highlight && (
                ...
                <Button
                  className={`relative mt-8 w-full h-11 overflow-hidden rounded-lg text-white font-semibold text-sm border-none shadow-lg transition-all ${
                    plan.highlight
