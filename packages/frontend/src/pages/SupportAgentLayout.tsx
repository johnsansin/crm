...
export function SupportAgentLayout() {
  ...
  return <div className="flex h-screen min-h-0 flex-col overflow-hidden bg-slate-100 dark:bg-slate-950">
    <header className="flex h-16 shrink-0 items-center gap-3 border-b bg-white px-4 shadow-sm dark:bg-slate-900 sm:px-6">
