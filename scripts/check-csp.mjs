...
for (const path of ['/', '/', '/login', '/signup', '/pricing', '/socialforce-demo', '/contact', '/privacy-policy', '/terms', '/cookie-policy', '/refund-policy']) {
  ...
  for (const directive of ["default-src 'none'", "base-uri 'none'", "form-action 'self'", "object-src 'none'", "frame-ancestors 'self'", "script-src-attr 'none'", "style-src-attr 'none'", "'strict-dynamic'", 'upgrade-insecure-requests']) {
